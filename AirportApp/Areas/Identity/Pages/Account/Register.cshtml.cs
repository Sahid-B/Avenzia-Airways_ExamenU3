        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Add the verification code as a user claim
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Código de Verificación - Avenzia Airways",
                        $"Hola,<br/><br/>Tu código de verificación para activar tu cuenta de Avenzia Airways es:<br/><br/>" +
                        $"<h2 style='color:#7E91B3; font-weight:bold; letter-spacing:2px;'>{code}</h2><br/>" +
                        $"Ingresa este código en la pantalla de verificación para continuar.<br/><br/>¡Gracias por registrarte!");
